...
MatchingService.ctorParameters = () => [
    { type: _global_api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }
];
MatchingService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RecruiterService", function() { return RecruiterService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var _models_classes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../models/classes */ "./src/app/core/models/classes/index.ts");
/* harmony import */ var _global_api_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../global/api.service */ "./src/app/core/services/global/api.service.ts");
...
let RecruiterService = class RecruiterService {
    ...
    read(search) {
        ...
        return this.apiService.get('account-ms/recruiters', params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((x) => {
     ...
     */
    update(recruiter) {
        return this.apiService.put(`account-ms/recruiters/${recruiter._id}`, recruiter).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(x => {
            this.$recruiter.next(new _models_classes__WEBPACK_IMPORTED_MODULE_4__["Recruiter"](Object.assign(this.$recruiter.value.getValues(), x)));
        }));
    }
    /**
     ...
     */
    delete(id) {
        return this.apiService.delete(`account-ms/recruiters/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(x => {
     ...
     */
    readOne(id) {
        return this.apiService.get(`account-ms/recruiters/${id}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(res => {
            this.$recruiter.next(new _models_classes__WEBPACK_IMPORTED_MODULE_4__["Recruiter"](res));
        }));
    }
    /**
...
RecruiterService.ctorParameters = () => [
    { type: _global_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"] }
];
RecruiterService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], RecruiterService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PictureUtilsService", function() { return PictureUtilsService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let PictureUtilsService = class PictureUtilsService {
    constructor(camera) {
        this.camera = camera;
    ...
    uploadFromCamera() {
        return new Promise((resolve, reject) => {
            this.camera.getPicture(this.takePictureOptions).then((imageData) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    uploadFromGallery() {
        return new Promise((resolve, reject) => {
            this.camera.getPicture(this.galleryOptions).then((imageData) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                resolve({ imageData: 'data:image/jpeg;base64,' + imageData }); // convert picture to blob
            }), (err) => {
                reject(err);
            });
...
PictureUtilsService.ctorParameters = () => [
    { type: _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_2__["Camera"] }
];
PictureUtilsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], PictureUtilsService);
